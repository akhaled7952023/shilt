...
return new class extends Migration
{
    ...
    {
        Schema::create('chefz_orders', function (Blueprint $table) {
            $table->id();
            $table->foreignId('import_batch_id')->constrained('chefz_import_batches');
            ...
            $table->unique(['monthly_period_id', 'order_id_platform'], 'chefz_orders_period_order_uq');
            $table->index(['monthly_period_id', 'delegate_id'], 'chefz_orders_period_delegate_idx');
    ...
    {
        Schema::dropIfExists('chefz_orders');
    }
};
