...
return new class extends Migration
{
    ...
    {
        Schema::create('chefz_delegate_settlements', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['monthly_period_id', 'delegate_id'], 'chefz_settlements_period_delegate_uq');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('chefz_delegate_settlements');
    }
};
