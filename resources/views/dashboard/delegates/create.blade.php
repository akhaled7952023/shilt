...
@section('title') إضافة مندوب @endsection
            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        <form class="form" action="{{ route('dashboard.delegates.store') }}"
                            ...
                            <div class="form-body">
                                ...
                                {{-- delegate_code يُولَّد تلقائياً من المنصة ولا يظهر للمشرف --}}
                                <input type="hidden" name="delegate_code" id="delegate_code_input" value="{{ old('delegate_code') }}">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="national_id" id="national_id_input"
                                                   ...
                                                   value="{{ old('national_id') }}" placeholder="رقم الهوية / الإقامة / المعرف">
                                    ...
                                    <div class="col-md-4" id="hs_rider_id_field" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hungerstation_rider_id" id="hs_rider_id_input"
                                                   class="form-control border-primary"
                                                   value="{{ old('hungerstation_rider_id') }}"
                            ...
                            <div class="form-actions right">
                                <a href="{{ route('dashboard.delegates.index') }}" class="mr-1 btn btn-warning">
