...
@section('title') إضافة مركبة @endsection
                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">إضافة مركبة</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        <form class="form" action="{{ route('dashboard.vehicles.store') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="plate_number" class="form-control border-primary"
                                                   value="{{ old('plate_number') }}" placeholder="مثال: أ ب ج 1234">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="make" class="form-control border-primary"
                                                   value="{{ old('make') }}" placeholder="مثال: تويوتا">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="model" class="form-control border-primary"
                                                   value="{{ old('model') }}" placeholder="مثال: كامري">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="year" class="form-control border-primary"
                                                   value="{{ old('year') }}" placeholder="{{ date('Y') }}" min="1900" max="2100">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="color" class="form-control border-primary"
                                                   value="{{ old('color') }}" placeholder="مثال: أبيض">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="chassis_number" class="form-control border-primary"
                                                   value="{{ old('chassis_number') }}" placeholder="VIN">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="inspection_issue_date" class="form-control border-primary"
                                                   value="{{ old('inspection_issue_date') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="inspection_expiry_date" class="form-control border-primary"
                                                   value="{{ old('inspection_expiry_date') }}">
                            ...
                            <div class="form-actions right">
                                <a href="{{ route('dashboard.vehicles.index') }}" class="mr-1 btn btn-warning">
